...
defaultModel =
  { state = Pause
  , ball = Ball 0 0 ballStartingVelocity ballStartingVelocity
...
updatePlayer dt points player =
  ...
  in
    { movedPlayer |
        y = clamp ((playerHeight/2+2)-halfHeight) (halfHeight-(playerHeight/2+2)) movedPlayer.y,
...
within paddle ball =
  near paddle.x 8 ball.x && near paddle.y (playerHeight/2) ball.y
